#!/usr/bin/env python3
"""Budget Suggestion Script - Data-Driven Budget Recommendations
...
Usage:
    uv run python app/skills/planning-budgets/scripts/suggest_budget.py

    Or with options via stdin JSON:
    echo '{"days": 90, "category": "FOOD_DINING"}' | uv run python suggest_budget.py
