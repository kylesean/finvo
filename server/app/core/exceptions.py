...
class AuthErrorCode(_ErrorCode):
    ...
    REGISTRATION_CLOSED = ("REGISTRATION_CLOSED", 1013)
...
class TransactionErrorCode(_ErrorCode):
    ...
    TRANSACTION_SYSTEM_READONLY = ("TRANSACTION_SYSTEM_READONLY", 3007)
    TRANSACTION_ACCOUNT_LINK_CLOSED = ("TRANSACTION_ACCOUNT_LINK_CLOSED", 3008)
