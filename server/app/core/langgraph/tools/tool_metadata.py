...
TOOL_METADATA: dict[str, ToolMetadata] = {
    ...
    "prepare_transfer": ToolMetadata(
        name="prepare_transfer",
        display_name="Prepare Transfer",
        side_effect=SideEffect.READ,
        continuation=Continuation.AGENT,
        output_policy=OutputPolicy.NORMAL,
        cancellable=True,
    ),
    "analyze_spending": ToolMetadata(
    ...
    "analyze_cashflow": ToolMetadata(
        name="analyze_cashflow",
        display_name="Analyze Cash Flow",
        side_effect=SideEffect.READ,
        continuation=Continuation.AGENT,
        output_policy=OutputPolicy.NORMAL,
        cancellable=True,
    ),
    "forecast_balance": ToolMetadata(
        name="forecast_balance",
        display_name="Forecast Balance",
        side_effect=SideEffect.READ,
        continuation=Continuation.AGENT,
        output_policy=OutputPolicy.NORMAL,
        cancellable=True,
    ),
    "list_spaces": ToolMetadata(
        name="list_spaces",
        display_name="List Shared Spaces",
        side_effect=SideEffect.READ,
        continuation=Continuation.AGENT,
        output_policy=OutputPolicy.NORMAL,
        cancellable=True,
    ),
    "query_space_summary": ToolMetadata(
        name="query_space_summary",
        display_name="Query Space Summary",
        side_effect=SideEffect.READ,
        continuation=Continuation.AGENT,
        output_policy=OutputPolicy.NORMAL,
        cancellable=True,
