...
async def get_current_user_info(
    ...
    user_info = UserInfoResponse(
        ...
        updatedAt=(
            current_user.updated_at.isoformat().replace("+00:00", "Z")
            if current_user.updated_at
            else current_user.created_at.isoformat().replace("+00:00", "Z")
        ),
        clientLastLoginAt=(
...
async def update_user_settings(
    ...
    settings_response = UserSettingsResponse(
        ...
        updatedAt=settings.updated_at.isoformat().replace("+00:00", "Z") if settings.updated_at else None,
    )
