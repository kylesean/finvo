...
@override@JsonKey(name: 'messageType', unknownEnumValue: MessageType.text) final  MessageType messageType;
@override@JsonKey(name: 'feedbackStatus', unknownEnumValue: AIFeedbackStatus.none) final  AIFeedbackStatus feedbackStatus;
@override@JsonKey(name: 'streamingStatus', unknownEnumValue: StreamingStatus.none) final  StreamingStatus streamingStatus;
