...
// Path: time
class _Translations$time$ja implements Translations$time$en {
	_Translations$time$ja._(this._root);
...
// Path: greeting
class _Translations$greeting$ja implements Translations$greeting$en {
	_Translations$greeting$ja._(this._root);
...
// Path: navigation
class _Translations$navigation$ja implements Translations$navigation$en {
	_Translations$navigation$ja._(this._root);
...
// Path: transaction
class _Translations$transaction$ja implements Translations$transaction$en {
	_Translations$transaction$ja._(this._root);
...
// Path: comment
class _Translations$comment$ja implements Translations$comment$en {
	_Translations$comment$ja._(this._root);
...
// Path: calendar
class _Translations$calendar$ja implements Translations$calendar$en {
	_Translations$calendar$ja._(this._root);
...
// Path: category
class _Translations$category$ja implements Translations$category$en {
	_Translations$category$ja._(this._root);
...
// Path: appearance
class _Translations$appearance$ja implements Translations$appearance$en {
	_Translations$appearance$ja._(this._root);
...
// Path: speech
class _Translations$speech$ja implements Translations$speech$en {
	_Translations$speech$ja._(this._root);
...
// Path: amountTheme
class _Translations$amountTheme$ja implements Translations$amountTheme$en {
	_Translations$amountTheme$ja._(this._root);
...
// Path: locale
class _Translations$locale$ja implements Translations$locale$en {
	_Translations$locale$ja._(this._root);
...
// Path: budget
class _Translations$budget$ja implements Translations$budget$en {
	_Translations$budget$ja._(this._root);
...
// Path: dateRange
class _Translations$dateRange$ja implements Translations$dateRange$en {
	_Translations$dateRange$ja._(this._root);
...
// Path: forecast
class _Translations$forecast$ja implements Translations$forecast$en {
	_Translations$forecast$ja._(this._root);
...
// Path: chat
class _Translations$chat$ja implements Translations$chat$en {
	_Translations$chat$ja._(this._root);
...
// Path: footprint
class _Translations$footprint$ja implements Translations$footprint$en {
	_Translations$footprint$ja._(this._root);
...
// Path: media
class _Translations$media$ja implements Translations$media$en {
	_Translations$media$ja._(this._root);
...
// Path: error
class _Translations$error$ja implements Translations$error$en {
	_Translations$error$ja._(this._root);
...
// Path: fontTest
class _Translations$fontTest$ja implements Translations$fontTest$en {
	_Translations$fontTest$ja._(this._root);
...
// Path: wizard
class _Translations$wizard$ja implements Translations$wizard$en {
	_Translations$wizard$ja._(this._root);
...
// Path: user
class _Translations$user$ja implements Translations$user$en {
	_Translations$user$ja._(this._root);
...
// Path: account
class _Translations$account$ja implements Translations$account$en {
	_Translations$account$ja._(this._root);
...
// Path: financial
class _Translations$financial$ja implements Translations$financial$en {
	_Translations$financial$ja._(this._root);
...
// Path: statistics
class _Translations$statistics$ja implements Translations$statistics$en {
	_Translations$statistics$ja._(this._root);
...
// Path: currency
class _Translations$currency$ja implements Translations$currency$en {
	_Translations$currency$ja._(this._root);
...
// Path: sharedSpace
class _Translations$sharedSpace$ja implements Translations$sharedSpace$en {
	_Translations$sharedSpace$ja._(this._root);
...
class _Translations$budgetSuggestion$ja implements Translations$budgetSuggestion$en {
	_Translations$budgetSuggestion$ja._(this._root);
...
// Path: server
class _Translations$server$ja implements Translations$server$en {
	_Translations$server$ja._(this._root);
...
// Path: errorMapping
class _Translations$errorMapping$ja implements Translations$errorMapping$en {
	_Translations$errorMapping$ja._(this._root);
...
// Path: auth.email
class _Translations$auth$email$ja implements Translations$auth$email$en {
	_Translations$auth$email$ja._(this._root);
...
// Path: auth.password
class _Translations$auth$password$ja implements Translations$auth$password$en {
	_Translations$auth$password$ja._(this._root);
...
class _Translations$auth$verificationCode$ja implements Translations$auth$verificationCode$en {
	_Translations$auth$verificationCode$ja._(this._root);
...
class _Translations$calendar$weekdays$ja implements Translations$calendar$weekdays$en {
	_Translations$calendar$weekdays$ja._(this._root);
...
class _Translations$appearance$palettes$ja implements Translations$appearance$palettes$en {
	_Translations$appearance$palettes$ja._(this._root);
...
class _Translations$forecast$recurringTransaction$ja implements Translations$forecast$recurringTransaction$en {
	_Translations$forecast$recurringTransaction$ja._(this._root);
	...
	@override String get cycle => 'サイクル';
	@override String get dayUnit => '日';
	@override String get weekUnit => '週';
	@override String get monthUnit => 'か月';
...
// Path: chat.tools
class _Translations$chat$tools$ja implements Translations$chat$tools$en {
	_Translations$chat$tools$ja._(this._root);

	final TranslationsJa _root; // ignore: unused_field

	// Translations
	@override String get processing => '処理中...';
	@override String get read_file => 'ファイルを確認中...';
	@override String get search_transactions => '取引を検索中...';
	@override String get query_budget_status => '予算を確認中...';
	@override String get create_budget => '予算プランを作成中...';
	@override String get get_cash_flow_analysis => 'キャッシュフローを分析中...';
	@override String get get_financial_health_score => '財務スコアを計算中...';
	@override String get get_financial_summary => 'レポートを生成中...';
	@override String get evaluate_financial_health => '財務状況を評価中...';
	@override String get forecast_balance => '残高を予測中...';
	@override String get simulate_expense_impact => '影響をシミュレーション中...';
	@override String get record_transactions => '記帳中...';
	@override String get create_transaction => '記帳中...';
	@override String get duckduckgo_search => 'ウェブを検索中...';
	@override String get execute_transfer => '振替を実行中...';
	@override String get list_dir => 'ディレクトリを表示中...';
	@override String get execute => 'スクリプトを実行中...';
	@override String get analyze_finance => '財務分析中...';
	@override String get forecast_finance => 'トレンド予測中...';
	@override String get analyze_budget => '予算分析中...';
	@override String get audit_analysis => '監査分析中...';
	@override String get budget_ops => '予算を処理中...';
	@override String get create_shared_transaction => '共有帳簿を作成中...';
	@override String get list_spaces => '共有スペースを取得中...';
	@override String get query_space_summary => 'スペース概要を確認中...';
	@override String get prepare_transfer => '振替を準備中...';
	...
	@override String get analyze_spending => 'Analyzing spendings...';
	@override String get analyze_cashflow => 'Analyzing cashflow...';
	@override String get suggest_budget => 'Suggesting budget...';
...
class _Translations$chat$transferWizard$ja implements Translations$chat$transferWizard$en {
	_Translations$chat$transferWizard$ja._(this._root);
...
// Path: chat.genui
class _Translations$chat$genui$ja implements Translations$chat$genui$en {
	_Translations$chat$genui$ja._(this._root);
...
// Path: chat.welcome
class _Translations$chat$welcome$ja implements Translations$chat$welcome$en {
	_Translations$chat$welcome$ja._(this._root);
...
// Path: error.genui
class _Translations$error$genui$ja implements Translations$error$genui$en {
	_Translations$error$genui$ja._(this._root);
...
// Path: account.types
class _Translations$account$types$ja implements Translations$account$types$en {
	_Translations$account$types$ja._(this._root);
...
class _Translations$statistics$overview$ja implements Translations$statistics$overview$en {
	_Translations$statistics$overview$ja._(this._root);
...
class _Translations$statistics$trend$ja implements Translations$statistics$trend$en {
	_Translations$statistics$trend$ja._(this._root);
...
class _Translations$statistics$analysis$ja implements Translations$statistics$analysis$en {
	_Translations$statistics$analysis$ja._(this._root);
...
class _Translations$statistics$filter$ja implements Translations$statistics$filter$en {
	_Translations$statistics$filter$ja._(this._root);
...
class _Translations$statistics$sort$ja implements Translations$statistics$sort$en {
	_Translations$statistics$sort$ja._(this._root);
...
class _Translations$statistics$emptyState$ja implements Translations$statistics$emptyState$en {
	_Translations$statistics$emptyState$ja._(this._root);
...
class _Translations$sharedSpace$dashboard$ja implements Translations$sharedSpace$dashboard$en {
	_Translations$sharedSpace$dashboard$ja._(this._root);
...
class _Translations$sharedSpace$roles$ja implements Translations$sharedSpace$roles$en {
	_Translations$sharedSpace$roles$ja._(this._root);
...
class _Translations$sharedSpace$create$ja implements Translations$sharedSpace$create$en {
	_Translations$sharedSpace$create$ja._(this._root);
...
class _Translations$sharedSpace$join$ja implements Translations$sharedSpace$join$en {
	_Translations$sharedSpace$join$ja._(this._root);
...
class _Translations$sharedSpace$list$ja implements Translations$sharedSpace$list$en {
	_Translations$sharedSpace$list$ja._(this._root);
...
class _Translations$sharedSpace$detail$ja implements Translations$sharedSpace$detail$en {
	_Translations$sharedSpace$detail$ja._(this._root);
...
class _Translations$sharedSpace$notifications$ja implements Translations$sharedSpace$notifications$en {
	_Translations$sharedSpace$notifications$ja._(this._root);
...
class _Translations$sharedSpace$inviteCard$ja implements Translations$sharedSpace$inviteCard$en {
	_Translations$sharedSpace$inviteCard$ja._(this._root);
...
class _Translations$sharedSpace$inviteSuccess$ja implements Translations$sharedSpace$inviteSuccess$en {
	_Translations$sharedSpace$inviteSuccess$ja._(this._root);
...
class _Translations$sharedSpace$notificationCard$ja implements Translations$sharedSpace$notificationCard$en {
	_Translations$sharedSpace$notificationCard$ja._(this._root);
...
class _Translations$sharedSpace$spaceCard$ja implements Translations$sharedSpace$spaceCard$en {
	_Translations$sharedSpace$spaceCard$ja._(this._root);
...
class _Translations$sharedSpace$settings$ja implements Translations$sharedSpace$settings$en {
	_Translations$sharedSpace$settings$ja._(this._root);
...
// Path: server.error
class _Translations$server$error$ja implements Translations$server$error$en {
	_Translations$server$error$ja._(this._root);
...
class _Translations$errorMapping$generic$ja implements Translations$errorMapping$generic$en {
	_Translations$errorMapping$generic$ja._(this._root);
...
class _Translations$errorMapping$auth$ja implements Translations$errorMapping$auth$en {
	_Translations$errorMapping$auth$ja._(this._root);
...
class _Translations$errorMapping$transaction$ja implements Translations$errorMapping$transaction$en {
	_Translations$errorMapping$transaction$ja._(this._root);
...
class _Translations$errorMapping$space$ja implements Translations$errorMapping$space$en {
	_Translations$errorMapping$space$ja._(this._root);
...
class _Translations$errorMapping$recurring$ja implements Translations$errorMapping$recurring$en {
	_Translations$errorMapping$recurring$ja._(this._root);
...
class _Translations$errorMapping$upload$ja implements Translations$errorMapping$upload$en {
	_Translations$errorMapping$upload$ja._(this._root);
...
class _Translations$errorMapping$storage$ja implements Translations$errorMapping$storage$en {
	_Translations$errorMapping$storage$ja._(this._root);
...
class _Translations$errorMapping$ai$ja implements Translations$errorMapping$ai$en {
	_Translations$errorMapping$ai$ja._(this._root);
...
class _Translations$notification$types$ja implements Translations$notification$types$en {
	_Translations$notification$types$ja._(this._root);
...
class _Translations$notification$semantic$ja implements Translations$notification$semantic$en {
	_Translations$notification$semantic$ja._(this._root);
...
class _Translations$chat$tools$done$ja implements Translations$chat$tools$done$en {
	_Translations$chat$tools$done$ja._(this._root);

	final TranslationsJa _root; // ignore: unused_field

	// Translations
	@override String get read_file => 'ファイルを確認しました';
	@override String get search_transactions => '取引を検索しました';
	@override String get query_budget_status => '予算を確認しました';
	@override String get create_budget => '予算を作成しました';
	@override String get get_cash_flow_analysis => 'キャッシュフローを分析しました';
	@override String get get_financial_health_score => 'スコアを計算しました';
	@override String get get_financial_summary => 'レポート生成完了';
	@override String get evaluate_financial_health => '財務評価完了';
	@override String get forecast_balance => '残高予測完了';
	@override String get simulate_expense_impact => 'シミュレーション完了';
	@override String get record_transactions => '記帳完了';
	@override String get create_transaction => '記帳しました';
	@override String get duckduckgo_search => '検索完了';
	@override String get execute_transfer => '振替完了';
	@override String get list_dir => 'ディレクトリ表示完了';
	@override String get execute => '実行完了';
	@override String get analyze_finance => '分析完了';
	@override String get forecast_finance => '予測完了';
	@override String get analyze_budget => '予算分析完了';
	@override String get audit_analysis => '監査完了';
	@override String get budget_ops => '予算処理完了';
	@override String get create_shared_transaction => '共有帳簿作成完了';
	@override String get list_spaces => '共有スペース取得完了';
	@override String get query_space_summary => '概要確認完了';
	@override String get prepare_transfer => '準備完了';
	@override String get unknown => '完了しました';
	@override String get analyze_spending => 'Spending analysis complete';
	@override String get analyze_cashflow => 'Cashflow analysis complete';
	@override String get suggest_budget => 'Budget suggestion complete';
...
class _Translations$chat$tools$failed$ja implements Translations$chat$tools$failed$en {
	_Translations$chat$tools$failed$ja._(this._root);
...
class _Translations$chat$genui$expenseSummary$ja implements Translations$chat$genui$expenseSummary$en {
	_Translations$chat$genui$expenseSummary$ja._(this._root);
...
class _Translations$chat$genui$transactionList$ja implements Translations$chat$genui$transactionList$en {
	_Translations$chat$genui$transactionList$ja._(this._root);
...
class _Translations$chat$genui$transactionGroupReceipt$ja implements Translations$chat$genui$transactionGroupReceipt$en {
	_Translations$chat$genui$transactionGroupReceipt$ja._(this._root);
...
class _Translations$chat$genui$transactionCard$ja implements Translations$chat$genui$transactionCard$en {
	_Translations$chat$genui$transactionCard$ja._(this._root);
...
class _Translations$chat$genui$cashFlowCard$ja implements Translations$chat$genui$cashFlowCard$en {
	_Translations$chat$genui$cashFlowCard$ja._(this._root);
...
class _Translations$chat$genui$budgetSimulator$ja implements Translations$chat$genui$budgetSimulator$en {
	_Translations$chat$genui$budgetSimulator$ja._(this._root);
...
class _Translations$chat$genui$budgetReceipt$ja implements Translations$chat$genui$budgetReceipt$en {
	_Translations$chat$genui$budgetReceipt$ja._(this._root);
...
class _Translations$chat$genui$budgetStatusCard$ja implements Translations$chat$genui$budgetStatusCard$en {
	_Translations$chat$genui$budgetStatusCard$ja._(this._root);
...
class _Translations$chat$genui$cashFlowForecast$ja implements Translations$chat$genui$cashFlowForecast$en {
	_Translations$chat$genui$cashFlowForecast$ja._(this._root);
...
class _Translations$chat$genui$healthScore$ja implements Translations$chat$genui$healthScore$en {
	_Translations$chat$genui$healthScore$ja._(this._root);
...
class _Translations$chat$genui$spaceSelector$ja implements Translations$chat$genui$spaceSelector$en {
	_Translations$chat$genui$spaceSelector$ja._(this._root);
...
class _Translations$chat$genui$transferPath$ja implements Translations$chat$genui$transferPath$en {
	_Translations$chat$genui$transferPath$ja._(this._root);
...
class _Translations$chat$genui$transactionConfirmation$ja implements Translations$chat$genui$transactionConfirmation$en {
	_Translations$chat$genui$transactionConfirmation$ja._(this._root);
...
class _Translations$chat$genui$budgetAnalysis$ja implements Translations$chat$genui$budgetAnalysis$en {
	_Translations$chat$genui$budgetAnalysis$ja._(this._root);
...
class _Translations$chat$welcome$morning$ja implements Translations$chat$welcome$morning$en {
	_Translations$chat$welcome$morning$ja._(this._root);
...
class _Translations$chat$welcome$midday$ja implements Translations$chat$welcome$midday$en {
	_Translations$chat$welcome$midday$ja._(this._root);
...
class _Translations$chat$welcome$afternoon$ja implements Translations$chat$welcome$afternoon$en {
	_Translations$chat$welcome$afternoon$ja._(this._root);
...
class _Translations$chat$welcome$evening$ja implements Translations$chat$welcome$evening$en {
	_Translations$chat$welcome$evening$ja._(this._root);
...
class _Translations$chat$welcome$night$ja implements Translations$chat$welcome$night$en {
	_Translations$chat$welcome$night$ja._(this._root);
...
class _Translations$chat$genui$healthScore$status$ja implements Translations$chat$genui$healthScore$status$en {
	_Translations$chat$genui$healthScore$status$ja._(this._root);
...
class _Translations$chat$welcome$morning$breakfast$ja implements Translations$chat$welcome$morning$breakfast$en {
	_Translations$chat$welcome$morning$breakfast$ja._(this._root);
...
class _Translations$chat$welcome$morning$yesterdayReview$ja implements Translations$chat$welcome$morning$yesterdayReview$en {
	_Translations$chat$welcome$morning$yesterdayReview$ja._(this._root);
...
class _Translations$chat$welcome$morning$todayBudget$ja implements Translations$chat$welcome$morning$todayBudget$en {
	_Translations$chat$welcome$morning$todayBudget$ja._(this._root);
...
class _Translations$chat$welcome$midday$lunch$ja implements Translations$chat$welcome$midday$lunch$en {
	_Translations$chat$welcome$midday$lunch$ja._(this._root);
...
class _Translations$chat$welcome$midday$weeklyExpense$ja implements Translations$chat$welcome$midday$weeklyExpense$en {
	_Translations$chat$welcome$midday$weeklyExpense$ja._(this._root);
...
class _Translations$chat$welcome$midday$checkBalance$ja implements Translations$chat$welcome$midday$checkBalance$en {
	_Translations$chat$welcome$midday$checkBalance$ja._(this._root);
...
class _Translations$chat$welcome$afternoon$quickRecord$ja implements Translations$chat$welcome$afternoon$quickRecord$en {
	_Translations$chat$welcome$afternoon$quickRecord$ja._(this._root);
...
class _Translations$chat$welcome$afternoon$analyzeSpending$ja implements Translations$chat$welcome$afternoon$analyzeSpending$en {
	_Translations$chat$welcome$afternoon$analyzeSpending$ja._(this._root);
...
class _Translations$chat$welcome$afternoon$budgetProgress$ja implements Translations$chat$welcome$afternoon$budgetProgress$en {
	_Translations$chat$welcome$afternoon$budgetProgress$ja._(this._root);
...
class _Translations$chat$welcome$evening$dinner$ja implements Translations$chat$welcome$evening$dinner$en {
	_Translations$chat$welcome$evening$dinner$ja._(this._root);
...
class _Translations$chat$welcome$evening$todaySummary$ja implements Translations$chat$welcome$evening$todaySummary$en {
	_Translations$chat$welcome$evening$todaySummary$ja._(this._root);
...
class _Translations$chat$welcome$evening$tomorrowPlan$ja implements Translations$chat$welcome$evening$tomorrowPlan$en {
	_Translations$chat$welcome$evening$tomorrowPlan$ja._(this._root);
...
class _Translations$chat$welcome$night$makeupRecord$ja implements Translations$chat$welcome$night$makeupRecord$en {
	_Translations$chat$welcome$night$makeupRecord$ja._(this._root);
...
class _Translations$chat$welcome$night$monthlyReview$ja implements Translations$chat$welcome$night$monthlyReview$en {
	_Translations$chat$welcome$night$monthlyReview$ja._(this._root);
...
class _Translations$chat$welcome$night$financialThinking$ja implements Translations$chat$welcome$night$financialThinking$en {
	_Translations$chat$welcome$night$financialThinking$ja._(this._root);
...
extension on TranslationsJa {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'forecast.recurringTransaction.dayUnit' => '日',
			'forecast.recurringTransaction.weekUnit' => '週',
			'forecast.recurringTransaction.monthUnit' => 'か月',
			...
			'chat.tools.read_file' => 'ファイルを確認中...',
			'chat.tools.search_transactions' => '取引を検索中...',
			'chat.tools.query_budget_status' => '予算を確認中...',
			'chat.tools.create_budget' => '予算プランを作成中...',
			'chat.tools.get_cash_flow_analysis' => 'キャッシュフローを分析中...',
			'chat.tools.get_financial_health_score' => '財務スコアを計算中...',
			'chat.tools.get_financial_summary' => 'レポートを生成中...',
			'chat.tools.evaluate_financial_health' => '財務状況を評価中...',
			'chat.tools.forecast_balance' => '残高を予測中...',
			'chat.tools.simulate_expense_impact' => '影響をシミュレーション中...',
			'chat.tools.record_transactions' => '記帳中...',
			'chat.tools.create_transaction' => '記帳中...',
			'chat.tools.duckduckgo_search' => 'ウェブを検索中...',
			'chat.tools.execute_transfer' => '振替を実行中...',
			'chat.tools.list_dir' => 'ディレクトリを表示中...',
			'chat.tools.execute' => 'スクリプトを実行中...',
			'chat.tools.analyze_finance' => '財務分析中...',
			'chat.tools.forecast_finance' => 'トレンド予測中...',
			'chat.tools.analyze_budget' => '予算分析中...',
			'chat.tools.audit_analysis' => '監査分析中...',
			'chat.tools.budget_ops' => '予算を処理中...',
			'chat.tools.create_shared_transaction' => '共有帳簿を作成中...',
			'chat.tools.list_spaces' => '共有スペースを取得中...',
			'chat.tools.query_space_summary' => 'スペース概要を確認中...',
			'chat.tools.prepare_transfer' => '振替を準備中...',
			'chat.tools.unknown' => 'リクエストを処理中...',
			'chat.tools.done.read_file' => 'ファイルを確認しました',
			'chat.tools.done.search_transactions' => '取引を検索しました',
			'chat.tools.done.query_budget_status' => '予算を確認しました',
			'chat.tools.done.create_budget' => '予算を作成しました',
			'chat.tools.done.get_cash_flow_analysis' => 'キャッシュフローを分析しました',
			'chat.tools.done.get_financial_health_score' => 'スコアを計算しました',
			'chat.tools.done.get_financial_summary' => 'レポート生成完了',
			'chat.tools.done.evaluate_financial_health' => '財務評価完了',
			'chat.tools.done.forecast_balance' => '残高予測完了',
			'chat.tools.done.simulate_expense_impact' => 'シミュレーション完了',
			'chat.tools.done.record_transactions' => '記帳完了',
			'chat.tools.done.create_transaction' => '記帳しました',
			'chat.tools.done.duckduckgo_search' => '検索完了',
			'chat.tools.done.execute_transfer' => '振替完了',
			'chat.tools.done.list_dir' => 'ディレクトリ表示完了',
			'chat.tools.done.execute' => '実行完了',
			'chat.tools.done.analyze_finance' => '分析完了',
			'chat.tools.done.forecast_finance' => '予測完了',
			'chat.tools.done.analyze_budget' => '予算分析完了',
			'chat.tools.done.audit_analysis' => '監査完了',
			'chat.tools.done.budget_ops' => '予算処理完了',
			'chat.tools.done.create_shared_transaction' => '共有帳簿作成完了',
			'chat.tools.done.list_spaces' => '共有スペース取得完了',
			'chat.tools.done.query_space_summary' => '概要確認完了',
			'chat.tools.done.prepare_transfer' => '準備完了',
